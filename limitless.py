...
commands = {
	"white_all_on" : bytearray([0x35, 0x00, 0x55]),
...
def set_brightness(hub, light, type, current_brightness, requested_brightness):
	...
	if type == "white":
		...
		logger.debug("Changing (converted) brightness from " + str(current_brightness) + " to " + str(requested_brightness))
